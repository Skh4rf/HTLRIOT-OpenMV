...
sensor.set_vflip(False) # Optionale Bildkorrektur durch vertikale Ausrichtung
sensor.set_hmirror(False) # Optionale Bildkorrektur durch horizontale Spiegelung
sensor.skip_frames(time = 2000) # Frames überspringen um fehlerhafte Frames nach Sensorinitialiserung zu verhindern
