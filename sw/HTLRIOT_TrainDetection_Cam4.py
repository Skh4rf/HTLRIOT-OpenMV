...
while(True):
    ...
    thresholdCorner = (0, 100, 16, 63, 10, 127)
    thresholdTrain1 = (30,60,10,45,-40,0)
    ...
    try: # Abfangen möglicher Frame-Buffer Probleme in der Runtime
        ...
        blobsCorner = img.find_blobs([thresholdCorner], area_threshold=15, merge=True) #Suchen nach Eck-Markierungen
